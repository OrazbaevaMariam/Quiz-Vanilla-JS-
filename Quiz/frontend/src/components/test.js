...
export class Test {
    ...
    startQuiz() {
        ...
        // this.passQuestionButtonElement = document.getElementById('passQuestion');
        // this.passQuestionButtonElement.onclick = this.move.bind(this, 'passQuestion');
    ...
    chooseAnswer() {
        this.nextButtonElement.removeAttribute('disabled');
        // this.passQuestionButtonElement.setAttribute('disabled', 'disabled');
    }
